...
import LivePreview from './white-label/LivePreview';
import CssEditor from './white-label/CssEditor';
import DomainConfiguration from './white-label/DomainConfiguration';
          ...
          <Tabs defaultValue="branding" className="space-y-6">
            ...
            <TabsContent value="styling">
              <CssEditor
                ...
                onChange={(css) => setConfig(prev => ({ ...prev, custom_css: css }))}
              />
            </TabsContent>
            ...
            <TabsContent value="domain">
              <DomainConfiguration
                ...
                onChange={(domain) => setConfig(prev => ({ ...prev, custom_domain: domain }))}
              />
            </TabsContent>

            <TabsContent value="preview">
              <LivePreview config={config} onApplyPreview={previewChanges} />
            </TabsContent>
          </Tabs>
